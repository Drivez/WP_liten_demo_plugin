...
Installing "Liten Demo" can be done either by searching for "Liten Demo" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
